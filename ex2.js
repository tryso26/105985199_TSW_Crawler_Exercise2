...
window.onload = function() {
    ...
    const text_MC = "一位從手機直播應用程式「REALITY」誕生的歌手。HACHI以透明感十足、如絲絹般的嗓音和卓越的歌唱力撼動了眾多用戶的心弦，話題不斷而逐步積累了越來越多的粉絲。隨著活動平台轉移至YouTube，於每週兩次的歌唱直播中，透過她最擅長的武器——溶入情感的歌聲，以及與聽眾心靈相伴的對話，更使得訂閱者數量迅速增加。2022年9月舉行了首次現場演唱會「Midnight blue」。她的人氣跨越國界，獲得來自台灣、韓國以及北美等地用戶的支持。作為一位在日本、海外、直播以及虛擬舞台活動的次世代歌手，受到了廣泛的關注。";
    // 當鼠標移入時顯示MC文本
